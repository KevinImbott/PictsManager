...
class DialogChooseShare extends StatefulWidget {
  const DialogChooseShare({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              Container(
                margin: EdgeInsets.only(top: 25, bottom: 15, right: 4,left: 0),
            child:
            Align(
              ...
              child: IconButton(
                ...
                icon: Icon(Icons.supervised_user_circle_rounded,   size: 50.0,
                ),
                onPressed: () {
                  setState(() {
